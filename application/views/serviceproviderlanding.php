<html>
<head>
<title>eHelp- Service Provider Home</title>
	...
	<tr>
		<td  colspan="5" height="489"" align="left" valign="top" bgcolor="#D6D6D6" style="background-color: #D7D6D6"><p>&nbsp;</p>
		    ...
		    <p><span id="welcome">Welcome <?php echo $userName ?>,</span></p>
                    <p style="text-align:center;color: maroon;font-weight:bold;">Active Service Requests</p>
		 <?php
                  echo "<table align='center' width='743' id='customers' border='1'><tr><th>Accept</th><th>Date</th><th>Time</th><th>Category</th><th>Name</th><th>Address</th></tr>";
                   echo form_open('main/sp_response');

                  foreach($query as $row)
                   {
                   echo "<tr><td><input type='radio' name='q2' value='$row->rid' /></td><td>".$row->date."</td><td>".$row->time."</td><td>".$row->cname."</td><td>".$row->fname."</td><td>".$row->address."</td></tr>";
                   }
                  echo "</table>";
